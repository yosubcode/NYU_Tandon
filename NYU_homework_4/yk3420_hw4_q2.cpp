...
int main(){
    ...
    // While Loop to process each digit and convert to Roman numeral
    while (n > 0){
        remainder = n % 10;
        placeValue = remainder * multiplyer ;
